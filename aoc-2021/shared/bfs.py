...
class BFS:
    def __init__(self,
                 ...
                 neighbor_function: Callable[[Any, Iterable[Any], Iterable[Any], Iterable[Any]], Iterable[Any]],
    ...
    def run(self):
        ...
        while not queue.empty():
            ...
            if self.end_condition(curr_node, self.search_space):
                ...
                for neighbor, weight in self.neighbor_function(curr_node, path, seen, self.search_space):
